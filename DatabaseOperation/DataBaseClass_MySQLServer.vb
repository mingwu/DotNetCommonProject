...
Namespace DatabaseOperation
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class DataBase_MySQLServer
        ...
        ''' </summary>
        ''' <remarks></remarks>
        Private _ConnectionObject As MySqlClient.MySqlConnection 'SqlClient.SqlConnection = Nothing
        ...
        Public Overloads Overrides Sub Open()
            _ConnectionObject = New MySqlClient.MySqlConnection(_ConnectionString)
            If _ConnectionObject.State <> ConnectionState.Open Then
                Try
                    _ConnectionObject.Open()
                Catch ex As Exception
                    'Throw New Exception("Error :" + ex.Message)
                    _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute Open() Error:" + ex.Message + ex.StackTrace)
                End Try
            End If
        End Sub
        ...
        Public Overloads Overrides Sub Open(ByVal ConnectionString As String)
            _ConnectionObject = New MySqlClient.MySqlConnection(ConnectionString)
            If _ConnectionObject.State <> ConnectionState.Open Then
                Try
                    _ConnectionObject.Open()
                Catch ex As Exception
                    'Throw New Exception("Error :" + ex.Message)
                    _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute Open(ConnectionString) Error:" + ex.Message + ex.StackTrace)
                End Try
            End If
        End Sub
        ...
        ''' <remarks></remarks>
        Protected Function CreateCmd(ByVal SqlString As String, ByVal ConnectionObject As MySqlClient.MySqlConnection) As MySqlClient.MySqlCommand
            Try
                Dim _Command As New MySqlClient.MySqlCommand(SqlString, ConnectionObject)
                Return _Command
            Catch ex As Exception
        ...
        ''' <returns>Command对象</returns>
        ''' <remarks></remarks>
        Protected Function CreateCmd(ByVal SqlString As String, ByVal ConnectionObject As MySqlClient.MySqlConnection, ByVal Parameters() As SqlClient.SqlParameter, ByVal CommondType As Data.CommandType) As MySqlClient.MySqlCommand
            Try
                Dim _Cmd As New MySqlClient.MySqlCommand(SqlString, ConnectionObject)
        ...
        Public Overrides Sub Close()
            If _ConnectionObject.State = ConnectionState.Open Then
                ...
                Catch ex As Exception
                    'Throw New Exception("Error :" + ex.Message)
                    _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute Close() Error:" + ex.Message + ex.StackTrace)
                End Try
            End If
        ...
        Public Overrides Function ExecuteSql(ByVal SqlString As String) As System.Data.DataTable
            ...
            da = New MySqlClient.MySqlDataAdapter(SqlString, _ConnectionObject)
            ...
            Catch ex As Exception
                ...
                'Throw New Exception("Error :" + ex.Message)
                _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute ExecuteSql(SqlString) Sql:" + SqlString + " Error:" + ex.Message + ex.StackTrace)
            End Try
            Me.Close()
            'Return Nothing
            Return DataTableObj
        ...
        Public Overrides Function ExecuteSqlNonQuery(ByVal SqlString As String, ByVal Parameters() As SqlClient.SqlParameter)
            Me.Open(_ConnectionString)
            Dim _CommandObj As MySqlClient.MySqlCommand
            'Dim _SqlTransaction As SqlClient.SqlTransaction = _ConnectionObject.BeginTransaction
            '_CommandObj.Transaction = _SqlTransaction New
            Try
        ...
        Public Overloads Overrides Function ExecuteSql(ByVal SqlString As String, ByVal DataTableObj As System.Data.DataTable) As System.Data.DataTable
            ...
            Catch ex As Exception
                'Throw New Exception("Error :" + ex.Message)
                _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute ExecuteSql(SqlString,DataTableObj) Sql:" + SqlString + " Error:" + ex.Message + ex.StackTrace)
            End Try
            Me.Close()
            Return DataTableObj
        End Function
        ...
        Public Overloads Overrides Function ExecuteSql(ByVal SqlString As String, ByVal DataTableObj As System.Data.DataTable, ByVal Parameters() As SqlClient.SqlParameter) As System.Data.DataTable
            ...
            Catch ex As Exception
                'Throw New Exception("Error :" + ex.Message)
                _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute ExecuteSql(SqlString,DataTableObj,Parameters()) Sql:" + SqlString + " Error:" + ex.Message + ex.StackTrace)
            End Try
            Me.Close()
            Return DataTableObj
        End Function
        ...
        Public Overloads Overrides Function ExecuteSql(ByVal SqlString As String, ByVal DataTableObj As System.Data.DataTable, ByVal PageSize As Integer, ByVal PageNo As Integer) As System.Data.DataTable
            ...
            Catch ex As Exception
                ' Throw New Exception("Error :" + ex.Message)
                _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute ExecuteSql(SqlString,DataTableObj,PageSize,PageNo) Sql:" + SqlString + " Error:" + ex.Message + ex.StackTrace)
            End Try
            Me.Close()
            Return DataTableObj
        End Function
        ...
        Public Overloads Overrides Function ExecuteSql(ByVal SqlString As String, ByVal DataTableObj As System.Data.DataTable, ByVal PageSize As Integer, ByVal PageNo As Integer, ByVal Parameters() As SqlClient.SqlParameter) As System.Data.DataTable
            ...
            Catch ex As Exception
                ' Throw New Exception("Error :" + ex.Message)
                _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute ExecuteSql(SqlString,DataTableObj,PageSize,PageNo,Parameters) Sql:" + SqlString + " Error:" + ex.Message + ex.StackTrace)
            End Try
            Me.Close()
            Return DataTableObj
        End Function
        ...
        '''' <remarks></remarks>
        'Public Function ExecuteSqlReturnDataReader(ByVal SqlString As String) As MySqlClient.MySqlDataReader
        '    Me.Open(_ConnectionString)
        '    Dim dr As MySqlClient.MySqlDataReader = Nothing
        '    Try
        '        Dim _CommandObj As MySqlClient.MySqlCommand
        '        _CommandObj = CreateCmd(SqlString, _ConnectionObject)
        ...
        '        Return dr
        '    Catch ex As Exception
        '        _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute ExecuteSqlReturnDataReader(SqlString) Sql:" + SqlString + " Error:" + ex.Message + ex.StackTrace)
        '    End Try
        '    Return dr
        '    Me.Close()
        'End Function
        ...
        '''' <returns>返回SqlDataReader对象</returns>
        '''' <remarks></remarks>
        'Public Function ExecuteSqlReturnDataReader(ByVal SqlString As String, ByVal Parameters As SqlClient.SqlParameter()) As MySqlClient.MySqlDataReader
        '    Me.Open(_ConnectionString)
        '    Dim dr As MySqlClient.MySqlDataReader = Nothing
        '    Try
        '        Dim _CommandObj As MySqlClient.MySqlCommand
        ...
        '    Catch ex As Exception
        '        ' Throw New Exception("Error :" + ex.Message)
        '        _Log.Fatal("[DatabaseOperation.DataBase_MySQLServer]Execute ExecuteSql(SqlString,DataTableObj,PageSize,PageNo) Error:" + ex.Message + ex.StackTrace)
        '    End Try
        '    Me.Close()
        '    Return DataTableObj
        'End Function
